...
area and perimeter, string representations, and a destructor
that prints a message when an instance is deleted.
"""
...
class Rectangle:
    ...
    def __str__(self):
        ...
        Returns:
            str: A rectangle drawn with # characters, one row per line.
        """
        if self.__width == 0 or self.__height == 0:
            return ""
